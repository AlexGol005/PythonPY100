def digits(N):
    ...
    min_digit_index = digits_list.index(min(digits_list))
    print(even_place)
    return digits_list, sum_, sum_even, how_many_digits, min_, max_, difference, min_digit_index



if __name__ == "__main__":
    print(digits(20345607))
